...
const SAMPLE_POSTS: Post[] = [
    ...
    },
    {
        ...
        author: ME,
        media: [
            { id: 'm2', type: 'image', src: '/images/iphone.jpg', alt: 'Exam problems' },
            { id: 'm3', type: 'image', src: '/images/avatar1.jpg', alt: 'Solutions' },
        ],
        caption: 'Bộ đề luyện đề chuyên sâu — link tài liệu trong bio',
        tags: ['#luyenthi', '#dethi'],
        createdAt: nowISO(),
        likes: 256,
        comments: [],
