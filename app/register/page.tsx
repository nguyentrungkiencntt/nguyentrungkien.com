...
export default function MyWindsorLoginPage() {
    ...
    async function handleLogin(e?: React.FormEvent) {
        ...
        try {
            ...
            setError(null)
            setIsAcctive("Đang đăng ký tài khoản ...");
            setIsCreate(true);
            setTimeout(() => {
                setIsAcctive("Đăng ký tài khoản thành công");
                setTimeout(() => {
                    setIsCreate(false);
                    redirect("/login");
                }, 2000)
            ...
            >
                ...
                <div id="login" className="col-span-12 lg:col-span-5 p-8">
                    <motion.div initial={{ x: 20, opacity: 0 }} animate={{ x: 0, opacity: 1 }}>
                        {<div>
                            <h3 className="text-xl font-semibold">Đăng ký tài khoản myVerse</h3>
                            <p className="text-sm text-gray-500 mt-1">Nhập tên tài khoản, số điện thoại và mật khẩu để đăng ký tài khoản.</p>
